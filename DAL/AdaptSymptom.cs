...
namespace HTNResp.DAL
{
	...
	/// 数据访问类:AdaptSymptom
	/// </summary>
	public partial class AdaptSymptom
	{
		public AdaptSymptom()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "AdaptSymptom"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from AdaptSymptom");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(HTNResp.Model.AdaptSymptom model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into AdaptSymptom(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(HTNResp.Model.AdaptSymptom model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update AdaptSymptom set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from AdaptSymptom ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public HTNResp.Model.AdaptSymptom GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,DecisionRule,Contents,Sex,Status,Sort,Separator,TypeName,Remark,EvalGuidId from AdaptSymptom ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			HTNResp.Model.AdaptSymptom model=new HTNResp.Model.AdaptSymptom();
		...
		/// 得到一个对象实体
		/// </summary>
		public HTNResp.Model.AdaptSymptom DataRowToModel(DataRow row)
		{
			HTNResp.Model.AdaptSymptom model=new HTNResp.Model.AdaptSymptom();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM AdaptSymptom ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from AdaptSymptom T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "AdaptSymptom";
